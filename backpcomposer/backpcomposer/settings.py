"""
Django settings for backpcomposer project.
...
SECRET_KEY = 'django-insecure-$_@7z7*_mg#-boi4n^gw8jnn74w2_t1fc3gj_bd_)o67wj*6yu'
...
ROOT_URLCONF = 'backpcomposer.urls'
...
WSGI_APPLICATION = 'backpcomposer.wsgi.application'
